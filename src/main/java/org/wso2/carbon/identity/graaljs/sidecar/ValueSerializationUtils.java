...
public final class ValueSerializationUtils {
    ...
    private static Map<String, Object> deserializeProxyMarker(SerializedProxyObject proxy) {
        ...
        marker.put(SidecarConstants.IS_HOST_REF, true);
        marker.put(SidecarConstants.PROXY_TYPE_FIELD, proxy.getType());
        marker.put(SidecarConstants.REFERENCE_ID_FIELD, proxy.getReferenceId());
